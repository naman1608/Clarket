...
function populate(s1, s2) {
  ...
  if (s1.value.toLowerCase() == "furniture") {
    optionsArr = [
      "Table|Table",
      "Chair|Chair",
      "Almirah|Almirah",
  ...
  } else if (s1.value.toLowerCase() == "electronics") {
    optionsArr = [
      "Mobile|Mobile",
      "Laptop|Laptop",
      "Headphone|Headphone",
  ...
  } else if (s1.value.toLowerCase() == "books") {
    optionsArr = [
      "Sem1|Semester 1",
      "Sem2|Semester 2",
      "Sem3|Semester 3",
  ...
  } else if (s1.value.toLowerCase() == "beddings") {
    optionsArr = [
      "Bedsheet|Bedsheet",
      "Pillow|Pillow",
      "Curtains|Curtains",
  ...
  } else if (s1.value.toLowerCase() == "bathroom accessories") {
    optionsArr = [
      "Tub|Tub",
      "Mug|Mug",
  ...
  } else if (s1.value.toLowerCase() == "kitchen accessories") {
    optionsArr = [
      "Induction|Induction",
      "Kettle|Kettle",
      "Utensils|Utensils",
